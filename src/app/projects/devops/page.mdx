...
export const article = {
  ...
  description:
    "Code für den gesamten Lebenszyklus der Anwendungsentwicklung auf Azure: CI/CD-Pipelines, Infrastructure as Code mit Bicep und Containerisierung mit Docker.",
   githubUrl: "https://github.com/LeonR92/devops",
  slug: "DevOps",
}

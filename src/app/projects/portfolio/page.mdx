...
export const article = {
  author: 'Leon Richard',
  date: '2025-03-01',
  title: 'Persönliches Portfolio-Projekt',
  description:
    'Eine moderne und performante Portfolio-Website, basierend auf einem vorgefertigten Template, individuell angepasst und auf Vercel gehostet, um meine Projekte, Fähigkeiten und Erfahrungen zu präsentieren.',
  githubUrl: 'https://github.com/LeonR92/Portfolio',
  slug: 'portfolio',
}

...
export const article = {
  author: 'Leon Richard',
  date: '2025-03-13',
  title: 'AuthService mit Python Flask und DevOps-Prinzipien',
  description:
    'Ein hochskalierbarer Authentifizierungsdienst mit Flask,. Setzt auf eine duale PostgreSQL-Architektur mit Lese-/Schreib-Trennung, Lastverteilung via HAProxy und optimiertes Connection-Handling durch PgBouncer.',
  githubUrl: "https://github.com/LeonR92/AuthService",
  slug: "authservice-flask-devops",
}

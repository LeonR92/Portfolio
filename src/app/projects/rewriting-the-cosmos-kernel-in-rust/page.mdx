...
export const article = {
  ...
  description:
    'Ein schlanker Authentifizierungsdienst, implementiert mit Flask und konzipiert nach Repository-Architektur und einfachen DevOps-Prinzipien. Dank Docker Compose ist das Deployment einfach und reproduzierbar.',

...
export const article = {
  author: 'Leon Richard',
  date: '2026-01-03',
  title: 'Agentic-AI Projekt',
  description:
    'Lokale Agentic AI zur Zusammenfassung strukturierter und unstrukturierter Daten – datenschutzkonform via SLM (Small Language Model) und PydanticAI',
  githubUrl: 'https://github.com/LeonR92/crm-insight',
  slug: 'Agentic-AI',
}

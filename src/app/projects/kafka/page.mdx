...
export const article = {
  author: 'Leon Richard',
  date: '2025-03-16',
  title: 'Distributed Echtzeit-Bestellmanagement',
  description:
    "Ein skalierbares Echtzeit-Bestellsystem mit distributed Kafka-Architektur, Dual-Write-Persistenz und dynamischen SSE-Updates für zuverlässige und schnelle Datenverarbeitung.",

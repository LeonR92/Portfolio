...
export const article = {
  author: 'Leon Richard',
  date: '2025-03-16',
  title: 'Verteiltes Echtzeit-Bestellmanagement',
  description:
    "Ein einfaches Echtzeit-Bestellsystem mit verteilter Kafka-Architektur. Bestellungen werden asynchron verarbeitet und über Server-Sent Events (SSE) in Echtzeit aktualisiert, während PostgreSQL als transaktionale Persistenzschicht dient.",
   githubUrl: "https://github.com/LeonR92/OrderStream/tree/main",
  slug: "dashboard",
}

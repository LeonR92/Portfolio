...
export const article = {
  author: 'Leon Richard',
  date: '2023-10-01',
  title: 'Data-Engineering und DevOps – Ein experimenteller Ansatz',
  description:
    'Ein archiviertes Projekt zur Integration von MySQL, Terraform, Docker und Streamlit für eine End-to-End-Data-Pipeline vom Source bis zum Dashboard.',
  githubUrl: "https://github.com/LeonR92/Dashboard",
  slug: "dashboard",
}
